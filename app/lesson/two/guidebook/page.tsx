    ...
    <div className="bg-gray-700 dark:bg-gray-700 min-h-screen p-6">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6">
        ...
        <ul className="list-disc list-inside mb-4 text-gray-800">
          <li><strong>Ég, mig, mér, mín</strong> (I, me): Different forms of the pronoun &apos;I&apos; used depending on the sentence structure.</li>
          <li><strong>Þú, þig, þér, þín</strong> (You): These are variations of &apos;you&apos;, used in different contexts in Icelandic.</li>
          ...
          <li><strong>Hvaðan</strong> (Where from): &apos;Hvaðan&apos; is used for asking about origin, most often where people are from.</li>
          <li><strong>Er/Ert</strong> (Is/Am/Are): &apos;Er/Ert&apos; are forms of the verb &apos;to be&apos;.</li>
        ...
        <p className="text-gray-800 mt-4">Notice there are more than one ways to say &apos;Me&apos; and &apos;You&apos;. We will dive deeper into why and when to use each version later, don&apos;t worry too much about that now.</p>
