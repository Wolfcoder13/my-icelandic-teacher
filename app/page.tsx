...
import icelandSvg from '../assets/iceland.svg'
              ...
              <div className="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20   ">
                <a href="/lesson/1"
                  ...
                  <div className="py-2 px-9 relative  ">
                    ...
                    <h3 className="mt-8 text-lg font-semibold text-black group-hover:text-white ">Greetings & Introductions
                    </h3>
                    <p className="mt-4 text-base text-gray-600 group-hover:text-white  ">
                      Here we learn how to say hello, say your name, ask others for their name, and say good bye.
                    </p>
                  </div>
                </a>
